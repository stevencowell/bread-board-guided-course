(function () {
  ...
  bar.setAttribute("aria-label", "Bread Board course navigation");
  ...
  brand.innerHTML = '<span class="course-family-nav__mark" aria-hidden="true">BB</span><span>Bread Board</span>';
